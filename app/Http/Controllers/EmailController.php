...
class EmailController extends Controller
{
        ...
        try {
            ...
            if ($emailConfig->emailConfigName != request('emailConfigName')) {
                return response()->json([
                    'status' => 'error',
                    'error' => 'Email config name is not correct.'
                ], 400);
            }
            //set the config
            config([
    ...
    public function getEmails(): JsonResponse
    {
        try {
            ...
            return response()->json(['error' => 'An error occurred during getting emails. Please try again later.'], 500);
        }
    }
    ...
    public function getSingleEmail(Request $request): JsonResponse
    {
        try {
            ...
            return response()->json(['error' => 'An error occurred during getting single email. Please try again later.'], 500);
        }
    }
    ...
    public function deleteEmail(Request $request): JsonResponse
    {
        try {
            ...
            return response()->json(['error' => 'An error occurred during deleting email. Please try again later.'], 500);
        }
    }
}
